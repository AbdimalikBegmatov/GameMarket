        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DeveloperCompany = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Rait = table.Column<float>(type: "real", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_AddedTime",
                table: "Orders",
                column: "AddedTime");

            migrationBuilder.CreateIndex(
                name: "IX_Orders_ShippedTime",
                table: "Orders",
                column: "ShippedTime");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_DeveloperCompany",
                table: "Products",
                column: "DeveloperCompany");
